...
import mainScreenshot from '../../assets/screenshots/main.png';
...
<Image src={mainScreenshot} alt="Raffi launcher screenshot" width={800} />
...
<summary>Window Manager Integration</summary>
    ...
    ```ini
    # Sway
    bindsym $super+Space exec cmd=$(raffi -p) && [ -n "$cmd" ] && swaymsg exec -- "$cmd"
...
- [Install Raffi](/installation/) — Get started with installation via cargo, AUR, Homebrew, or build from source
- [Quick Start](/quickstart/) — Configure and launch your first application with Raffi
